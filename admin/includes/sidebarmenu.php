						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
									 ...
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Guides</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="create-guide.php">Create</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-guides.php">Manage</a></li>
										  </ul>
										</li>
									...
									<li><a href="monuments.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Monument</span><div class="clearfix"></div></a></li>
